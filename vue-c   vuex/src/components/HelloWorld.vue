<template>
  <div class="hello">
    内容:{{ getInput1 }}   {{ getInput2 }}
		
    <p style="text-indent: 0;">
      <a id='a' href="#middlePopover" class="mui-btn mui-btn-primary mui-btn-block mui-btn-outlined"
         style="padding: 5px 20px;">打开弹出菜单</a>
    </p>
      ...
      <div class="mui-scroll-wrapper">
        <div class="mui-scroll">
          ...
          <div v-if="isCxy" id="bttn2" :style="bttn2Style">
            <input class="inp" type="text" v-model="input1">
            <input class="inp" type="text" v-model="input2">
  ...
  export default {
    ...
    methods: {
      ...
      btn2() {
        ...
        this.$store.state.input1 = this.input1;
        this.$store.state.input2 = this.input2;
